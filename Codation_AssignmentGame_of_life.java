package codatation;
import java.util.*;
public class Codation_AssignmentGame_of_life 
{
		...
		public final static int Alive=1; //for alive we puted 1 and final to make it constant
		 ...
		 public void get()
		 {
		  ...
		  public void getStates()
		   {
		    ...
		    do {
		      ...
		      System.out.println("*****Start*****");
		       ...
		       System.out.println("2.Cell is dead or alive");
		  ...
		  public static void main(String[] args)
		  {
		    ...
		    Codation_AssignmentGame_of_life  gm=new Codation_AssignmentGame_of_life();
